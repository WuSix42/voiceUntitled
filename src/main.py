...
mdxnet_models_dir = os.path.join(BASE_DIR, 'is_models')
rvc_models_dir = os.path.join(BASE_DIR, 'models')
output_dir = os.path.join(BASE_DIR, 'opt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-dir', '--rvc-dirname', type=str, required=True, help='Name of the folder in the models directory containing the RVC model file and optional index file to use')
